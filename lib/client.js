...
var defaultConfig = {
    ...
    requestLimit: 20,           // Maximum number of requests to the Discogs API per interval
    requestLimitAuth: 25,       // Maximum number of requests to the Discogs API per interval when authenticated
